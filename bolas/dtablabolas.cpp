...
DTablaBolas::DTablaBolas(QVector<Bola*> bPasadas, QWidget *parent) : QDialog( parent ) {
		setupUi(this);
...
bool ModeloTabla::setData( const QModelIndex &indice, const QVariant &value, int role ) {
